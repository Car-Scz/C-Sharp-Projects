...
class Program
{
    static void Main()
    {
        ...
        // Create a one dimensional array with initialization and declaration combined
        string[] dim1 = new string[5] { "Element 1", "Element 2", "Element 3", "Element 4", "Element 5" };
        ...
        while (isInfinite)
        {
            ...
            Console.WriteLine("Hey! I'm writing this over... and over... and over...");
            isInfinite = false;    // infinity loop fix
        }
